...
function Process() {
  const steps = [
    ...
    { n: "02", title: "一緒に試す", desc: "まずは月3万円のおためしで、実際の会話に置いてみます。請求書の下書きが自分の現場から出てくるかを、いっしょに確かめます。合わなければ翌月でやめられます。", when: "おためし" },
  ...
  const plans = [
    {
      ...
      price: "¥30,000",
      unit: "/月（1ヶ月ごと）",
      note: "1グループ・縛りなし / いつでもやめられる",
      feats: ["請求書の下書きまで、ぜんぶ動く", "設定はこちらでやり、初月はいっしょに回す", "記録はあなたのスプレッドシートに残る", "合わなければ翌月でやめられる"],
      cta: "まず試したい"
    },
    {
      tier: "BUSINESS",
      ...
      price: "¥100,000",
      unit: "/月（年間契約）",
      note: "導入費0円・〜5グループ / おためしから移行なら初月0円",
      featured: true,
      feats: ["LINEグループは5つまで（以上は相談）", "タスク抽出・日次サマリー・請求書ドラフト無制限", "導入支援こみ（ヒアリング・設計・LINE導入）＝初期費用0円", "毎月いっしょに改善（月次まとめ＋チューニング）", "現場の運用まで、ぜんぶ併走", "おためしから移行なら、初月の運用料は0円"],
      cta: "話を聞きに行きます"
    },
  ];
  return (
    <section id="pricing">
      <div className="wrap">
        <div className="section-head reveal">
          ...
          <p>いまtotolineは現場テストの最中で、月に3社までしかお受けできません。だから料金も「大きく契約する前に、自分の現場で試せる」つくりにしています。まずは月3万円のおためしで、請求書の下書きが自分の会話から出てくるところまで見てから、本導入を決められます。</p>
        </div>
...
function FAQ() {
  const items = [
    ...
    { q: "セットアップは、自分でやらないといけませんか？", a: "いいえ。おためし（月3万円）でも本導入（月10万円）でも、設定はこちらでやります。おためしは最初のひと月をいっしょに回し、本導入は現場ヒアリング・スプレッドシート設計・LINE導入・運用までを含みます。お客様側の作業は最小限です。" },
    { q: "おためしプランは、何ができますか？", a: "おためし（月3万円・1グループ・1ヶ月ごと・縛りなし）では、請求書の下書きを含めて、ぜんぶの機能が動きます。設定はこちらで行い、最初のひと月はいっしょに回します。合わなければ翌月でやめられ、記録はお客様自身のスプレッドシートに残ります。「まず自分の現場で試したい」方向けです。" },
    { q: "プランは、どう選べばいいですか？", a: "プランは2つです。まず自分の現場で試したいなら おためし（月3万円・1グループ・1ヶ月ごと・縛りなし）。現場ごと任せて毎月いっしょに改善したいなら 本導入（月10万円・年間契約・導入費0円・〜5グループ）です。おためしから本導入に移る場合、初月の運用料は0円になります。5グループより大きい規模や、会計ソフトとの連携が必要な場合は、相談しながら見積もります。" },
