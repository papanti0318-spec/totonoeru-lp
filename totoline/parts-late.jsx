...
function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      price: "¥50,000",
      unit: "〜/月",
      note: "導入 ¥90,000 / 〜5グループ・規模に応じて相談",
      featured: true,
      feats: ["LINEグループは5つまで（以上は相談）", "会話を台帳に自動保存・自動振り分け", "請求書ドラフト無制限", "月次まとめ＋改善の相談", "現場ヒアリングから運用まで、ぜんぶ併走", "最初の1ヶ月、運用料金は発生しません"],
      cta: "話を聞きに行きます"
    },
  ];
  return (
    <section id="pricing">
      <div className="wrap">
        <div className="section-head reveal">
          ...
          <p>まず自分で試すなら Free。現場ごと任せるなら Business。Business は導入 ¥90,000 と月額 ¥50,000〜で、ヒアリングから運用まで併走します。最初の1ヶ月は、一緒に使ってみてから。</p>
        </div>
...
function FAQ() {
  const items = [
    ...
    { q: "セットアップは、自分でやらないといけませんか？", a: "Businessプランでは、導入費 ¥90,000 に、現場ヒアリング・スプレッドシート設計・LINE導入・1ヶ月の併走運用までが含まれます。お客様側の作業は最小限です。Freeプランはセルフ導入（マニュアル提供）になります。" },
    ...
    { q: "プランは、どう選べばいいですか？", a: "プランは2つです。まず自分で置いて試したいだけなら Free（1グループ・¥0）。タスク抽出や請求書ドラフトまでAIに任せ、現場ごと併走してほしいなら Business（導入 ¥90,000・月 ¥50,000〜・〜5グループ）です。5グループより大きい規模や、会計ソフトとの連携が必要な場合は、相談しながら見積もります。" },
